                        ...
                        <Col md={4} className="p-5">
                            <div style={{ backgroundColor: "white" }} className="rounded p-3">
                                <div className="d-flex justify-content-center">
                                    <img src={data[0]?.photo_worker} alt="" className="rounded-circle object-fit-cover" width={150} height={150} />
                                </div>
                                <div className="mt-2">
                                ...
                                <div>
                                    <button className="fw-bold border border-0 rounded py-2 text-white w-100" style={{ backgroundColor: "#5e50a1" }}>
                                        Hire
                                    </button>
                                </div>
                            </div>
                                        ...
                                        data[0].portofolio.slice(0, 6).map((portfolio, index) => (
                                            <Col key={index} md={4} sm={6} className="">
                                                <div className="text-center h-100">
                                                    <img src={portfolio.porto_photo} alt="portfolio" className="img-fluid rounded-3 h-75" />
                                ...
                                {data[0]?.experience &&
                                    data[0].experience.map((experience, index) => (
                                        <div key={index} className="d-flex gap-3">
                                            <img src={company_logo} alt="experience" width={84} height={84} />
                                            <div>
